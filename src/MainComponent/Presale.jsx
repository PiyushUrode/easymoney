...
import EMGT from "../assets/About/EMGTCOIN.png";
...
import step4icon from "../assets/About/EMGTCOIN.png";
...
const Presale = () => {
  ...
  return (
    <>
      <section className="w-full max-w-full max-h-svh  presalebackgroundimg relative` ">
        <div className="w-screen h-[100vh] absolute   z-10 bg-[#1b1a1ac7] flex flex-col items-center justify-center">
          {/* Glow Animation */}
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: [1, 1.2, 1] }}
            transition={{ repeat: Infinity, duration: 3 }}
            className="absolute w-60 h-screen bg-[#FFA100] rounded-full text-center opacity-20 blur-3xl"
          />
          ...
          <motion.h1
            ...
            className="text-3xl md:text-7xl font-bold strategy-partner-h1 z-10 tracking-wide leading-normal py-5 cursor-pointer hover:scale-105 transition-transform"
          >
            Coming Soon
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-6 text-gray-300 text-md md:text-xl z-10"
          >
        ...
        <div className="flex flex-col md:flex-row  text-white px-6 lg:px-16 py-5 md:py-16 rounded-lg max-w-7xl mx-auto ">
          ...
          <div className="flex flex-col w-full justify-center  align-middle md:w-1/2 px-4 md:px-8">
            <h5
              className="text-3xl md:text-4xl text-white font-extrabold mb-4 leading-tight"
              style={{
            ...
            >
              Easy Money Global Token Presale – Spend Less, Earn More with EMGT{" "}
            </h5>
            <p className="text-white mb-6 text-sm md:text-base">
              EM Global Token (EMGT) aims to simplify and grow your earnings
              with real utility, smart automation, and passive income — creating
              a sustainable ecosystem where every interaction benefits you
            </p>
            <div className="flex gap-4">
              <button
                className=" text-black px-5 py-2 rounded-md font-bold text-sm md:text-base"
                style={{
                  background:
                    "radial-gradient(130.8% 130.8% at 0% 7.5%, #FFDD70 0%, #FFC300 32.9%, #C29400 61.9%, #453804 100%)",
                }}
              >
                Buy Now
              </button>
              <button className="border border-gray-400 text-yellow-400 px-5 py-2 rounded-md text-sm md:text-base">
                Refer Now
              </button>
            </div>
          </div>
              ...
              <div className="bg-[#2C2C2C] p-6 rounded-lg">
                <div className="flex justify-between items-center mb-6">
                  <div className="text-center">
                    <h5 className="text-gray-400 text-xs md:text-sm">
                      Total Coin Sales USD
                    </h5>
                    <h5 className="text-white font-bold text-sm md:text-lg">
                      $15,756,435.59
                    </h5>
                  </div>
                ...
                <div className="relative w-full max-w-[500px] h-[40px] bg-black rounded-full flex items-center p-1 shadow-md border border-gray-700">
                  ...
                  <div className="relative z-10 flex justify-between w-full px-4 text-white font-semibold text-sm">
                    <span className="text-[10px] sm:text-[10px] md:text-md ">
                      Remaining {value}M
                    </span>
                  </div>
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, #EABA1D 21.9%, #000000 100%)",
                    }}
                  >
                ...
                <div className="flex justify-between my-4 text-xs md:text-sm">
                  <h5 className="text-gray-300">0.0045 USDT = 1 EMGT</h5>
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #000000 18.9%, #EABA1D 100%)",
                  }}
                >
        ...
        {/* next down section */}
        <div className="flex hidden flex-col w-full justify-center items-center ">
          <div className="w-full flex flex-col justify-center items-center text-center">
            ...
            <div className="flex justify-center">
              <p className="text-[#ffffff] font-bold md:text-xl leading-relaxed w-full md:max-w-[100%] max-w-full text-2xl sm:text-3xl md:text-3xl lg:text-4xl">
                How to Buy EMGT CINEMA Token – Quick & Easy Guide
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row flex-wrap gap-5 justify-center items-center w-full p-5 py-20">
            ...
            <div className="flex flex-col items-center text-center">
              <div
                ...
                style={{
                  clipPath:
                    "polygon(25% 0%, 75% 0%, 100% 40%, 100% 99%, 0 100%, 0% 40%)",
                  background: "#1B1B1B",
                  height: "220px",
                  width: "300px",
              ...
              >
                ...
                <p className="text-[15px] font-bold">EMGTCINEMA.io</p>
                <p className="text-[10px]">
                  Visit EMGTCINEMA.IO and click on the “Buy Token” button on the
                  homepage.
                </p>
              </div>
              <div
            ...
            <div className="flex flex-col  items-center text-center ">
              ...
              >
                ...
                <p className="text-[10px]">
                  Connect your MetaMask wallet or Trust Wallet to the platform
                  and make sure you have USDT(Tether) in your wallet.
                </p>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              >
                ...
                <p className="text-[10px]">
                  Enter the amount of USDT you wish to use for purchasing EMGT
                  Cinema token and click on “APPROVE” to authorize the
                  transaction.
                </p>
              </div>
              <div
            ...
            <div className="flex flex-col items-center text-center ">
              ...
              >
                ...
                <p className="text-[10px]">
                  Enter the approved USDT amount and click “BUY” to finalize the
                  purchase. Check your wallet to confirm the EMGT Token
                  transaction.{" "}
                </p>
